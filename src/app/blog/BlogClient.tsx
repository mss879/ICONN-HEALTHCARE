  ...
  return (
    <div ref={containerRef} className="py-16 md:py-24 bg-white text-secondary space-y-20 md:space-y-28">
      ...
      {activePost && (
        ...
        >
          <div
            className="relative w-full max-w-3xl max-h-[85vh] overflow-y-auto bg-white p-8 md:p-10 rounded-3xl border border-card-border shadow-2xl space-y-6"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4 text-xs text-secondary-light">
                <span className="flex items-center space-x-1.5">
                  <Calendar className="h-4 w-4 text-gray-400" />
                  <time dateTime={activePost.publishedISO}>{activePost.date}</time>
                </span>
                <span className="flex items-center space-x-1.5">
                  <Clock className="h-4 w-4 text-gray-400" />
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 border-t border-card-border/40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass p-8 rounded-3xl border border-card-border bg-white shadow-sm space-y-4">
            ...
            <h3 className="text-lg font-bold text-secondary">Point of Care Integration</h3>
            <p className="text-sm text-secondary-light leading-relaxed font-normal">
          ...
          <div className="glass p-8 rounded-3xl border border-card-border bg-white shadow-sm space-y-4">
            ...
            <h3 className="text-lg font-bold text-secondary">Pathogen Control</h3>
            <p className="text-sm text-secondary-light leading-relaxed font-normal">
          ...
          <div className="glass p-8 rounded-3xl border border-card-border bg-white shadow-sm space-y-4">
            ...
            <h3 className="text-lg font-bold text-secondary">Reagent Quality</h3>
            <p className="text-sm text-secondary-light leading-relaxed font-normal">
