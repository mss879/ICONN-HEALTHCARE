...
import { ArrowRight, ArrowUpRight, ShieldCheck, Calendar, Clock, ChevronDown, Microscope, Dna, Users, Lightbulb, Award, ClipboardCheck, Settings, CheckCircle2 } from "lucide-react";
...
export default function HomeClient() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const dnaPairs = gsap.utils.toArray<HTMLElement>(".dna-pair");
      dnaPairs.forEach((pair, i) => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        const cards = gsap.utils.toArray<HTMLElement>(".foundation-card");
        cards.forEach((card) => {
          gsap.fromTo(card,
